...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=BAMLC0A4CBBBEY&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('BBB_Corporate_Bond_Yield.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'BBB_Corporate_Bond_Yield.csv'")
else:
