# Total Separations Rate: Leisure and Hospitality
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=JTS9000TSR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Total_Separations_Rate_Leisure_and_Hospitality.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Total_Separations_Rate_Leisure_and_Hospitality.csv'")
else:
