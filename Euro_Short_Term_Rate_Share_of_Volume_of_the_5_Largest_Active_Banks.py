...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=ECBESTRSHRVOL5LRGACTBNK&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Euro_Short_Term_Rate_Share_of_Volume_of_the_5_Largest_Active_Banks.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Euro_Short_Term_Rate_Share_of_Volume_of_the_5_Largest_Active_Banks.csv'")
else:
