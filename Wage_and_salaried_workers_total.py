...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SL.EMP.WORK.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Wage_and_salaried_workers_total.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Wage_and_salaried_workers_total.csv'")
else:
