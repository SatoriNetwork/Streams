# Private Short-Term Debt Securities
import requests
import json
import datetime as dt
import csv

url = "https://api.stlouisfed.org/fred/series/observations?series_id=DPSACBW027SBOG&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Private_Short_Term_Debt_Securities.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Private_Short_Term_Debt_Securities.csv'")
else:
