...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=TRUCKD11&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Truck_Tonnage_Index.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Truck_Tonnage_Index.csv'")
else:
