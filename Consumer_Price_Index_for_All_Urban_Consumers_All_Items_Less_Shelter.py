...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CUSR0000SA0L2&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open(' Consumer_Price_Index_for_All_Urban_Consumers_All_Items_Less_Shelter.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Consumer_Price_Index_for_All_Urban_Consumers_All_Items_Less_Shelter.csv'")
else:
