...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=OBMMIC30YFLVLE80FB700A719&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('30_Year_Fixed_Rate_Conforming_Mortgage_Index_Loan_to_Value_Less_Than_or_Equal_to_8__FICO_Score_Between_700_and_719.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to '30_Year_Fixed_Rate_Conforming_Mortgage_Index_Loan_to_Value_Less_Than_or_Equal_to_8__FICO_Score_Between_700_and_719.csv'")
else:
