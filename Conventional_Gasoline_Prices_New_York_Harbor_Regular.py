...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DGASNYH&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Conventional_Gasoline_Prices_New_York_Harbor_Regular.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Conventional_Gasoline_Prices_New_York_Harbor_Regular.csv'")
else:
