# Mining EmploymentMining Employment
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=USMINE&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Mining_Employment.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Mining_Employment.csv'")
else:
