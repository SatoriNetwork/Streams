...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GDP.TOTL.RT.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Total_natural_resources_rents.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Total_natural_resources_rents.csv'")
else:
