...
url = "https://api.eia.gov//v2//seriesid//PET.EER_EPJK_PF4_RGC_DPG.D?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('US_Gulf_Coast_Kerosene_Type_Jet_Fuel_Spot_Price_FOB.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to US_Gulf_Coast_Kerosene_Type_Jet_Fuel_Spot_Price_FOB.csv")
else:
