...
url = "https://api.eia.gov//v2//seriesid//PET.WGFUPUS2.W?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('US_Weekly_Finished_Motor_Gasoline_Product_Supplied.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to US_Weekly_Finished_Motor_Gasoline_Product_Supplied.csv")
else:
