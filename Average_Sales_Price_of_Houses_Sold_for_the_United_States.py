...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=ASPUS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Average_Sales_Price_of_Houses_Sold_for_the_United_States.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Average_Sales_Price_of_Houses_Sold_for_the_United_States.csv'")
else:
