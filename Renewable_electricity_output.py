...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EG.ELC.RNEW.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Renewable_electricity_output.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Renewable_electricity_output.csv'")
else:
