...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DHOILNYH&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('No_2_Heating_Oil_Prices_New_York_Harbor.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'No_2_Heating_Oil_Prices_New_York_Harbor.csv'")
else:
