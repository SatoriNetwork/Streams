...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=GASDESW&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Weekly_US_No_2_Diesel_Retail_Prices.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Weekly_US_No_2_Diesel_Retail_Prices.csv'")
else:
