...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=HSN1F&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('New_One_Family_Houses_Sold_United_States.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'New_One_Family_Houses_Sold_United_States.csv'")
else:
