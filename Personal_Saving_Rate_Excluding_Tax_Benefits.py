# Personal Saving Rate Excluding Tax Benefits
import requests
import json
import datetime as dt
import csv

url = "https://api.stlouisfed.org/fred/series/observations?series_id=DTBSPCKM&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Personal_Saving_Rate_Excluding_Tax_Benefits.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Personal_Saving_Rate_Excluding_Tax_Benefits.csv'")
else:
