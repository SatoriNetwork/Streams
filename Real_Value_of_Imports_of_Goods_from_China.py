# Real Value of Imports of Goods from China
import requests
import json
import datetime as dt
import csv

url = "https://api.stlouisfed.org/fred/series/observations?series_id=IMPCH&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Real_Value_of_Imports_of_Goods_from_China.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Real_Value_of_Imports_of_Goods_from_China.csv'")
else:
