...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=ECBMLFR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('ECB_Marginal_Lending_Facility_Rate_for_Euro_Area.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'ECB_Marginal_Lending_Facility_Rate_for_Euro_Area.csv'")
else:
