# Total Consumer Credit Index
import requests
import json
import datetime as dt
import csv

url = "https://api.stlouisfed.org/fred/series/observations?series_id=TOTALSA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Total_Consumer_Credit_Index.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Total_Consumer_Credit_Index.csv'")
else:
