...
url = "https://data.nasdaq.com/api/v3/datatables/QDL/BCHAIN?code=MWNUS&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('Bitcoin_My_Wallet_Number_of_users.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Bitcoin_My_Wallet_Number_of_users.csv")
else:
