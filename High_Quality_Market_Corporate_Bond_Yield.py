# High Quality Market Corporate Bond Yield
import requests
import json
import datetime as dt
import csv

url = "https://api.stlouisfed.org/fred/series/observations?series_id=HQMCB10YR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('High_Quality_Market_Corporate_Bond_Yield.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'High_Quality_Market_Corporate_Bond_Yield.csv'")
else:
