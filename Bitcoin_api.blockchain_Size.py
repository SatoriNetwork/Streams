...
url = "https://data.nasdaq.com/api/v3/datatables/QDL/BCHAIN?code=BLCHS&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('Bitcoin_api.blockchain_Size.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Bitcoin_api.blockchain_Size.csv")
else:
