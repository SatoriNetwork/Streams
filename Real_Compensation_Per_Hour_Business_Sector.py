...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=RCPHBS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Real_Compensation_Per_Hour_Business_Sector.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Real_Compensation_Per_Hour_Business_Sector.csv")
else:
