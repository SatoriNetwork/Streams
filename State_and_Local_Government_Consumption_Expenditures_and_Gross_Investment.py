...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=SLCEC1&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('State_and_Local_Government_Consumption_Expenditures_and_Gross_Investment.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'State_and_Local_Government_Consumption_Expenditures_and_Gross_Investment.csv'")
else:
