...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=LNS14000037&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Unemployment_Rate_20_Years_and_Over_Women.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Unemployment_Rate_20_Years_and_Over_Women.csv'")
else:
