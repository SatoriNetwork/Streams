...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=QUSR628BIS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Real_Residential_Property_Prices.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Real_Residential_Property_Prices.csv'")
else:
