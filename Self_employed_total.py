...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SL.EMP.SELF.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Self_employed_total.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Self_employed_total.csv'")
else:
