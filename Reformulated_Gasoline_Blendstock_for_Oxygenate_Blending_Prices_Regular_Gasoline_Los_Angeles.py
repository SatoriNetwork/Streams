...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DRGASLA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Reformulated_Gasoline_Blendstock_for_Oxygenate_Blending_Prices_Regular_Gasoline_Los_Angeles.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Reformulated_Gasoline_Blendstock_for_Oxygenate_Blending_Prices_Regular_Gasoline_Los_Angeles.csv'")
else:
