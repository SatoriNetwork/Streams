...
url = "https://data.nasdaq.com/api/v3/datatables/QDL/BCHAIN?code=TRFEE&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('Bitcoin_Total_Transaction_Fees.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Bitcoin_Total_Transaction_Fees.csv")
else:
