...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CPATAX&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Corporate_Profits_After_Tax.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Corporate_Profits_After_Tax.csv'")
else:
