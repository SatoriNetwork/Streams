...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=FFHTLOW&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Low_Value_of_the_Federal_Funds_Rate_for_the_Indicated_Date_Published_in_The_New_York_Herald_Tribune.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Low_Value_of_the_Federal_Funds_Rate_for_the_Indicated_Date_Published_in_The_New_York_Herald_Tribune.csv'")
else:
