...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=NDMANEMP&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Nondurable_Manufacturing_Employment.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Nondurable_Manufacturing_Employment.csv")
else:
