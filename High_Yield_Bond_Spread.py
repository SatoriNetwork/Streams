...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=BAMLH0A0HYM2&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('High_Yield_Bond_Spread.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'High_Yield_Bond_Spread.csv'")
else:
