# Montana Field Production of Crude Oil
# Generate CSV
import requests
import json
...
url = "https://api.eia.gov//v2//seriesid//PET.MCRFPMT2.M?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('Montana_Field_Production_of_Crude_Oil.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to Montana_Field_Production_of_Crude_Oil.csv")
else:
