# Implicit Price Deflator for Exports of Goods
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=IEABC&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Implicit_Price_Deflator_for_Exports_of_Goods.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Implicit_Price_Deflator_for_Exports_of_Goods.csv'")
else:
