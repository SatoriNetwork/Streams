...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EG.IMP.CONS.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Energy_imports.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Energy_imports.csv'")
else:
