...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=IUDZLS6&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Daily_Sterling_Overnight_Index_Average_Rate_10th_percentile.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Daily_Sterling_Overnight_Index_Average_Rate_10th_percentile.csv'")
else:
