...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=BAMLEMRACRPIASIAOAS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('ICE_BofA_Asia_Emerging_Markets_Corporate_Plus_Index_Option_Adjusted_Spread.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'ICE_BofA_Asia_Emerging_Markets_Corporate_Plus_Index_Option_Adjusted_Spread.csv'")
else:
