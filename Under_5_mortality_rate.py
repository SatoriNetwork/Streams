...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.DYN.MORT?format=json"
...
if response.status_code == 200:
    ...
    with open('Under_5_mortality_rate.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Under_5_mortality_rate.csv'")
else:
