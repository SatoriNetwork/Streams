...
url = "https://api.worldbank.org/v2/country/WLD/indicator/IT.NET.SECR.P6?format=json"
...
if response.status_code == 200:
    ...
    with open('Secure_Internet_servers.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Secure_Internet_servers.csv'")
else:
