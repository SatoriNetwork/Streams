...
url = "https://api.worldbank.org/v2/country/WLD/indicator/IC.REG.DURS?format=json"
...
if response.status_code == 200:
    ...
    with open('Time_required_to_start_a_business.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Time_required_to_start_a_business.csv'")
else:
