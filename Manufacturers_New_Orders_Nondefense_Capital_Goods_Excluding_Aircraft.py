...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=ANXAVS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open(' Manufacturers_New_Orders_Nondefense_Capital_Goods_Excluding_Aircraft.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Manufacturers_New_Orders_Nondefense_Capital_Goods_Excluding_Aircraft.csv'")
else:
