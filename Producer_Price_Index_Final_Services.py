# Producer Price Index: Final Services
import requests
import json
import datetime as dt
import csv

url = "https://api.stlouisfed.org/fred/series/observations?series_id=PPIFIS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Producer_Price_Index_Final_Services.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Producer_Price_Index_Final_Services.csv'")
else:
