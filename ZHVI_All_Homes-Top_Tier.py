...
url = "https://data.nasdaq.com/api/v3/datatables/ZILLOW/DATA?indicator_id=ZATT&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('ZHVI_All_Homes-Top_Tier.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to ZHVI_All_Homes-Top_Tier.csv")
else:
