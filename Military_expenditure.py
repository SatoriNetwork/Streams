...
url = "https://api.worldbank.org/v2/country/WLD/indicator/MS.MIL.XPND.GD.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Military_expenditure.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Military_expenditure.csv'")
else:
