# U.S. Weekly Kerosene-Type Jet Fuel Product Supplied
# Generate CSV
import requests
import json
...
url = "https://api.eia.gov//v2//seriesid//PET.WKJUPUS2.W?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('US_Weekly_Kerosene_Type_Jet_Fuel_Product_Supplied.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to US_Weekly_Kerosene_Type_Jet_Fuel_Product_Supplied.csv")
else:
