# Proportion of population with access to electricity, by urban/rural areas (%)
# Generate CSV
import requests
import json
...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EG.ELC.ACCS.UR.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Proportion_of_population_with_access_to_electricity.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Proportion_of_population_with_access_to_electricity.csv'")
else:
