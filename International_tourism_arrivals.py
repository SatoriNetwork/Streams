...
url = "https://api.worldbank.org/v2/country/WLD/indicator/ST.INT.ARVL?format=json"
...
if response.status_code == 200:
    ...
    with open('International_tourism_arrivals.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'International_tourism_arrivals.csv'")
else:
