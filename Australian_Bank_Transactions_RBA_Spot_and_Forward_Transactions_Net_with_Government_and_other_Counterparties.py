...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=AUINTDGT&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Australian_Bank_Transactions_RBA_Spot_and_Forward_Transactions_Net_with_Government_and_other_Counterparties.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Australian_Bank_Transactions_RBA_Spot_and_Forward_Transactions_Net_with_Government_and_other_Counterparties.csv'")
else:
