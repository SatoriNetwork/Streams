...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SL.AGR.EMPL.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Employment_in_agriculture.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Employment_in_agriculture.csv'")
else:
