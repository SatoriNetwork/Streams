...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=NONBORRES&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Reserves_Of_Depository_Institutions.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Reserves_Of_Depository_Institutions.csv")
else:
