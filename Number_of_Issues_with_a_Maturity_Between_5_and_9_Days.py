...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=AB59AAVOL&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Number_of_Issues_with_a_Maturity_Between_5_and_9_Days.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Number_of_Issues_with_a_Maturity_Between_5_and_9_Days.csv'")
else:
