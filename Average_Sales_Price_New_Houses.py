# Average Sales Price New Houses
import requests
import json
import datetime as dt
import csv

url = "https://api.stlouisfed.org/fred/series/observations?series_id=ASPNHSUS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Average_Sales_Price_New_Houses.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Average_Sales_Price_New_Houses.csv'")
else:
