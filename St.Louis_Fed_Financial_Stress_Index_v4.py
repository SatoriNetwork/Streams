# St. Louis Fed Financial Stress Index (Version 4)
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=STLFSI4&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("St.Louis_Fed_Financial_Stress_Index_v4.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to St.Louis_Fed_Financial_Stress_Index_v4.csv")
else:
