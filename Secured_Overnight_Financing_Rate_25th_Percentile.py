...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=SOFR25&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Secured_Overnight_Financing_Rate_25th_Percentile.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Secured_Overnight_Financing_Rate_25th_Percentile.csv'")
else:
