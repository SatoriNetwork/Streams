...
url = "https://api.worldbank.org/v2/country/WLD/indicator/GC.TAX.TOTL.GD.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Tax_revenue.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Tax_revenue.csv'")
else:
