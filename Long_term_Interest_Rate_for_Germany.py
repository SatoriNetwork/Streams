# Long-term Interest Rate for Germany
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=IRLTLT01DEM156N&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Long_term_Interest_Rate_for_Germany.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Long_term_Interest_Rate_for_Germany.csv'")
else:
