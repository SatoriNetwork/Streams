...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=SLOAS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("State_&_Local_Government_Current_Expenditures.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to State_&_Local_Government_Current_Expenditures.csv")
else:
