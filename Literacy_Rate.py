...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SE.ADT.LITR.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Literacy_Rate.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Literacy_Rate.csv'")
else:
