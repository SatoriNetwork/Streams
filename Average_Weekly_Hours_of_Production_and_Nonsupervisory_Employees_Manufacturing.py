...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=AWHMAN&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Average_Weekly_Hours_of_Production_and_Nonsupervisory_Employees_Manufacturing.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Average_Weekly_Hours_of_Production_and_Nonsupervisory_Employees_Manufacturing.csv")
else:
