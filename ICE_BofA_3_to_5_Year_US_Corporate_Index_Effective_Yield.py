...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=BAMLC2A0C35YEY&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("ICE_BofA_3_to_5_Year_US_Corporate_Index_Effective_Yield.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to ICE_BofA_3_to_5_Year_US_Corporate_Index_Effective_Yield.csv")
else:
