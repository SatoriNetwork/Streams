...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DDDI06USA156NWDB&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Long_term_Government_Bond_Yields_10_year_Main.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Long_term_Government_Bond_Yields_10_year_Main.csv'")
else:
