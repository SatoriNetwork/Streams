# Danish Kroner to U.S. Dollar Spot Exchange Rate
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DEXDNUS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Danish_Kroner_to_US_Dollar_Spot_Exchange_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Danish_Kroner_to_US_Dollar_Spot_Exchange_Rate.csv'")
else:
