...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=IPFPNSS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open(' Industrial_Production_Final_Products_and_Nonindustrial_Supplies.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Industrial_Production_Final_Products_and_Nonindustrial_Supplies.csv'")
else:
