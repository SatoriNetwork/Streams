...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EG.USE.CRNW.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Combustible_renewables_and_waste.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Combustible_renewables_and_waste.csv'")
else:
