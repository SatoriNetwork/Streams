...
url = "https://api.eia.gov//v2//seriesid//PET.WDISTUS1.W?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('Distillate_Fuel_Oil_Total_Stocks.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to Distillate_Fuel_Oil_Total_Stocks.csv")
else:
