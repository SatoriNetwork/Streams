...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EG.ELC.RNWX.KH?format=json"
...
if response.status_code == 200:
    ...
    with open('Renewable_electricity_output_excluding_hydroelectric.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Renewable_electricity_output_excluding_hydroelectric.csv'")
else:
