...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=NFCICREDIT&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open(' Credit_Component_of_Financial_Conditions.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Credit_Component_of_Financial_Conditions.csv'")
else:
