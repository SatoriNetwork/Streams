...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GDP.PCAP.PP.KD?format=json"
...
if response.status_code == 200:
    ...
    with open('GDP_per_capita_PPP_constant.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'GDP_per_capita_PPP_constant.csv'")
else:
