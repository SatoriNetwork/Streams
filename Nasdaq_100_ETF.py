...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=QQQ&outputsize=full&apikey=YOUR_API_KEY"
...
if response.status_code == 200:
    ...
    with open('Nasdaq_100_ETF.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Nasdaq_100_ETF.csv")
else:
