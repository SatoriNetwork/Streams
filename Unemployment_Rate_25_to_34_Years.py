...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=LNS14000026&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Unemployment_Rate_25_to_34_Years.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Unemployment_Rate_25_to_34_Years.csv'")
else:
