...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DJCA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Dow_Jones_Composite_Average.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Dow_Jones_Composite_Average.csv'")
else:
