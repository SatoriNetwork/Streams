...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CCLACBW027SBOG&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Consumer_Loans_Credit_Cards_and_Other_Revolving_Plans.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Consumer_Loans_Credit_Cards_and_Other_Revolving_Plans.csv'")
else:
