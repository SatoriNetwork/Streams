...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=OPHPBS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Business_Sector_Real_Output_Per_Hour_of_All_Persons.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Business_Sector_Real_Output_Per_Hour_of_All_Persons.csv'")
else:
