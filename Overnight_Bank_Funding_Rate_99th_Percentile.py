...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=OBFR99&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Overnight_Bank_Funding_Rate_99th_Percentile.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Overnight_Bank_Funding_Rate_99th_Percentile.csv'")
else:
