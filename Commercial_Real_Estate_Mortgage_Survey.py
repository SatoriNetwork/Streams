# Commercial Real Estate Mortgage Survey
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=COMPRMS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Commercial_Real_Estate_Mortgage_Survey.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Commercial_Real_Estate_Mortgage_Survey.csv'")
else:
