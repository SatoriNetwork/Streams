# Real Value of Imports from Japan
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=IMPJP&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Real_Value_of_Imports_from_Japan.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Real_Value_of_Imports_from_Japan.csv'")
else:
