...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=LFWA64TTUSM647S&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Working_Age_Population_Aged_15_64_All_Persons_for_the_United_States.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Working_Age_Population_Aged_15_64_All_Persons_for_the_United_States.csv'")
else:
