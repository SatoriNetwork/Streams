...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CURRSL&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Currency_Component_of_M1_Plus_Demand_Deposits.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Currency_Component_of_M1_Plus_Demand_Deposits.csv'")
else:
