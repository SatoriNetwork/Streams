# AMERIBOR Term-90 Derived Interest Rate Index 
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=AMBOR90T&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('AMERIBOR_Term_90_Derived_Interest_Rate_Index.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'AMERIBOR_Term_90_Derived_Interest_Rate_Index.csv'")
else:
