...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.ADJ.DFOR.GN.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Forest_depletion.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Forest_depletion.csv'")
else:
