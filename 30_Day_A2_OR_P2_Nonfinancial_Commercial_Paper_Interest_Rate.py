...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=RIFSPPNA2P2D30NB&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('30_Day_A2_OR_P2_Nonfinancial_Commercial_Paper_Interest_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to '30_Day_A2_OR_P2_Nonfinancial_Commercial_Paper_Interest_Rate.csv'")
else:
