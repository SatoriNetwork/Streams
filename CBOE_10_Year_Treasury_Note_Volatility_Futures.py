...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=VXTYN&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('CBOE_10_Year_Treasury_Note_Volatility_Futures.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'CBOE_10_Year_Treasury_Note_Volatility_Futures.csv'")
else:
