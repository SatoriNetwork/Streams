...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DFII10&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('10_Year_Treasury_Inflation_Indexed_Security.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to '10_Year_Treasury_Inflation_Indexed_Security.csv'")
else:
