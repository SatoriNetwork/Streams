...
url = "https://api.worldbank.org/v2/country/WLD/indicator/ST.INT.XPND.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('International_tourism_expenditures.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'International_tourism_expenditures.csv'")
else:
