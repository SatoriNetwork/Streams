...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NE.RSB.GNFS.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('External_balance_on_goods_and_services.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'External_balance_on_goods_and_services.csv'")
else:
