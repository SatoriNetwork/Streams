...
url = "https://api.worldbank.org/v2/country/WLD/indicator/BM.GSR.TRAN.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Transport_services.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Transport_services.csv'")
else:
