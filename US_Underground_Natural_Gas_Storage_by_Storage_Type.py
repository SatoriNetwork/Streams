...
url = "https://api.eia.gov//v2//seriesid//NG.N9140US2.M?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('US_Underground_Natural_Gas_Storage_by_Storage_Type.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to US_Underground_Natural_Gas_Storage_by_Storage_Type.csv")
else:
