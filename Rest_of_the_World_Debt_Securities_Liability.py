# Rest of the World; Debt Securities; Liability
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=ROWFDNQ027S&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open(' Rest_of_the_World_Debt_Securities_Liability.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Rest_of_the_World_Debt_Securities_Liability.csv'")
else:
