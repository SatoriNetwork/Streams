...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SP.POP.65UP.TO.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Population_ages_65_and_above.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Population_ages_65_and_above.csv'")
else:
