...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.ADJ.SVNG.GN.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Adjusted_net_savings.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Adjusted_net_savings.csv'")
else:
