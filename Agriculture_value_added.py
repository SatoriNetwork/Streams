...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NV.AGR.TOTL.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('Agriculture_value_added.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Agriculture_value_added.csv'")
else:
