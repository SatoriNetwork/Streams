# EONIA: Euro Interbank Offered Rate
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=EONIARATE&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Euro_Interbank_Offered_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Euro_Interbank_Offered_Rate.csv'")
else:
