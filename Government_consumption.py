...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NE.CON.GOVT.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Government_consumption.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Government_consumption.csv'")
else:
