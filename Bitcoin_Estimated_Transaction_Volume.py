...
url = "https://data.nasdaq.com/api/v3/datatables/QDL/BCHAIN?code=ETRAV&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('Bitcoin_Estimated_Transaction_Volume.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Bitcoin_Estimated_Transaction_Volume.csv")
else:
