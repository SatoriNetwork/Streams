...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=DIA&outputsize=full&apikey=YOUR_API_KEY"
...
if response.status_code == 200:
    ...
    with open('Dow_Jones_Industrial_Average_ETF.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Dow_Jones_Industrial_Average_ETF.csv")
else:
