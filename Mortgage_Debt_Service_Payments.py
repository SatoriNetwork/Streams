...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=MDSP&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Mortgage_Debt_Service_Payments.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Mortgage_Debt_Service_Payments.csv'")
else:
