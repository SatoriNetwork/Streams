...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SE.TER.ENRR?format=json"
...
if response.status_code == 200:
    ...
    with open('School_enrollment_tertiary.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'School_enrollment_tertiary.csv'")
else:
