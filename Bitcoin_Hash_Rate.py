...
url = "https://data.nasdaq.com/api/v3/datatables/QDL/BCHAIN?code=HRATE&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('Bitcoin_Hash_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Bitcoin_Hash_Rate.csv")
else:
