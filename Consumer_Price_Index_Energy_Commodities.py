...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CUSR0000SACE&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Consumer_Price_Index_Energy_Commodities.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Consumer_Price_Index_Energy_Commodities.csv'")
else:
