...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=BAMLHYH0A0HYM2TRIV&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('ICE_BofA_US_High_Yield_Index_Total_Return_Index_Value.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'ICE_BofA_US_High_Yield_Index_Total_Return_Index_Value.csv'")
else:
