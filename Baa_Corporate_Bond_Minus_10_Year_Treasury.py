...
if response.status_code == 200:
    ...
    with open("Baa_Corporate_Bond_Minus_10_Year_Treasury.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Baa_Corporate_Bond_Minus_10_Year_Treasury.csv")
else:
