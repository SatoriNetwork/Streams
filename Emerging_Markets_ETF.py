...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=EEM&outputsize=full&apikey=YOUR_API_KEY"
...
if response.status_code == 200:
    ...
    with open('Emerging_Markets_ETF.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to Emerging_Markets_ETF.csv")
else:
...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=AMZN&outputsize=full&apikey=YOUR_API_KEY"
response = requests.get(url)
