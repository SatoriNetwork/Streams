...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=FYFRGDA188S&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Federal_Receipts_as_Percent_of_GDP.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Federal_Receipts_as_Percent_of_GDP.csv")
else:
