...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CUSR0000SAH21&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Consumer_Price_Index_Rent_of_Primary_Residence.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Consumer_Price_Index_Rent_of_Primary_Residence.csv'")
else:
