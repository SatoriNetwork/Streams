# Job Postings on Indeed in New York
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=IHLIDXUSNY&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Job_Postings_on_Indeed_in_New_York.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Job_Postings_on_Indeed_in_New_York.csv'")
else:
