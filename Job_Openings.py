...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=JTSLDL&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    print("Data has been saved to 'Job_Openings.csv'")
else:
