...
url = "https://api.worldbank.org/v2/country/WLD/indicator/AG.LND.ARBL.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Arable_land.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Arable_land.csv'")
else:
