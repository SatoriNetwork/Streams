...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DFEDTARL&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Federal_Funds_Target_Range_Lower_Limit.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Federal_Funds_Target_Range_Lower_Limit.csv'")
else:
