# Industrial Production: Mining (except Oil and Gas)
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=IPG212S&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Industrial_Production_Mining_except_Oil_and_Gas.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Industrial_Production_Mining_except_Oil_and_Gas.csv'")
else:
