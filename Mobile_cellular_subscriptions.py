...
url = "https://api.worldbank.org/v2/country/WLD/indicator/IT.CEL.SETS.P2?format=json"
...
if response.status_code == 200:
    ...
    with open('Mobile_cellular_subscriptions.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Mobile_cellular_subscriptions.csv'")
else:
