...
url = "https://api.worldbank.org/v2/country/WLD/indicator/ER.H2O.FWTL.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Annual_freshwater_withdrawals_total.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Annual_freshwater_withdrawals_total.csv'")
else:
