# Ohio Residentia Electricity Price
# Generate CSV
import requests
import json
...
if response.status_code == 200:
    ...
    with open('Ohio_Residentia_Electricity_Price.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to Ohio_Residentia_Electricity_Price.csv")
else:
