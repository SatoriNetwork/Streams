# Total Separations Rate: Manufacturing
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=JTS3000TSR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Total_Separations_Rate_Manufacturing.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Total_Separations_Rate_Manufacturing.csv'")
else:
