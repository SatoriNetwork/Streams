...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=ECBMRRFR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('ECB_Main_Refinancing_Operations_Rate_Fixed_Rate_Tenders_for_Euro_Area.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'ECB_Main_Refinancing_Operations_Rate_Fixed_Rate_Tenders_for_Euro_Area.csv'")
else:
