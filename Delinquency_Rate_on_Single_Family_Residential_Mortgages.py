...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DRSDCIS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open(' Delinquency_Rate_on_Single_Family_Residential_Mortgages.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Delinquency_Rate_on_Single_Family_Residential_Mortgages.csv'")
else:
