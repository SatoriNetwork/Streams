...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=SPCS10RSA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('S&P_Case_Shiller_10_City_Composite_Home_Price_Index.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'S&P_Case_Shiller_10_City_Composite_Home_Price_Index.csv'")
else:
