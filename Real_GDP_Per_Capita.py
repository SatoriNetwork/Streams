...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=A939RX0Q048SBEA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Real_GDP_Per_Capita.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Real_GDP_Per_Capita.csv")
else:
