# Corruption Perceptions Index (0=highly corrupt to 100=very clean)
# Generate CSV
import requests
import json
...
url = "https://api.worldbank.org/v2/country/WLD/indicator/IQ.CPA.TRAN.XQ?format=json"
...
if response.status_code == 200:
    ...
    with open('Corruption_Perceptions_Index.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Corruption_Perceptions_Index.csv'")
else:
