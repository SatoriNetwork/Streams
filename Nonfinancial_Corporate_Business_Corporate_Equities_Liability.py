...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=NCBEILQ027S&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Nonfinancial_Corporate_Business_Corporate_Equities_Liability.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Nonfinancial_Corporate_Business_Corporate_Equities_Liability.csv'")
else:
