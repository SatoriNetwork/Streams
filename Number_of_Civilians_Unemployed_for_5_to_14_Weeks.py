...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=UEMP5TO14&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Number_of_Civilians_Unemployed_for_5_to_14_Weeks.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Number_of_Civilians_Unemployed_for_5_to_14_Weeks.csv'")
else:
