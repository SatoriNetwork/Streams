...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GNP.ATLS.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('GNI_Atlas_method.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'GNI_Atlas_method.csv'")
else:
