# Industrial Production: Software Publishers
# Generate CSV
import requests
import json
...
if response.status_code == 200:
    ...
    with open('Industrial_Production_Software_Publishers.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Industrial_Production_Software_Publishers.csv'")
else:
