# Capacity Utilization: Transportation Equipment
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CAPUTLG336S&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Capacity_Utilization_Transportation_Equipment.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Capacity_Utilization_Transportation_Equipment.csv'")
else:
