# Interest Coverage Ratio for United States
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=INTGSBUSM193N&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Interest_Coverage_Ratio_for_United_States.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Interest_Coverage_Ratio_for_United_States.csv'")
else:
