# Railroad Transportation: Labor Productivity
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=MPU4910063&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Railroad_Transportation_Labor_Productivity.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Railroad_Transportation_Labor_Productivity.csv'")
else:
