...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=OUTMS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Output_per_hour_manufacturing.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Output_per_hour_manufacturing.csv")
else:
