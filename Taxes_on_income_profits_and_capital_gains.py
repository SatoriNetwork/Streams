...
url = "https://api.worldbank.org/v2/country/WLD/indicator/GC.TAX.YPKG.RV.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Taxes_on_income_profits_and_capital_gains.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Taxes_on_income_profits_and_capital_gains.csv'")
else:
