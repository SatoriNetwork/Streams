...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SP.DYN.LE00.IN?format=json"
...
if response.status_code == 200:
    ...
    with open('Life_Expectancy-24.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Life_Expectancy-24.csv'")
else:
