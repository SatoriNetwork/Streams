...
if response.status_code == 200:
    ...
    with open("Consumer_Price_Index_for_All_Urban_Consumers_All_Items_Less_Food.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Consumer_Price_Index_for_All_Urban_Consumers_All_Items_Less_Food.csv")
else:
