# Recession Probability for United States
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=RECPROUSM156N&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Recession_Probability_for_United_States.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Recession_Probability_for_United_States.csv")
else:
