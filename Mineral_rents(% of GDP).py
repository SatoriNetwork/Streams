...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GDP.MINR.RT.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Mineral_rents(% of GDP).csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Mineral_rents(% of GDP).csv'")
else:
