# US Public Health Cost Index
import requests
import json
import datetime as dt
import csv

url = "https://api.stlouisfed.org/fred/series/observations?series_id=USPHCI&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('US_Public_Health_Cost_Index.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'US_Public_Health_Cost_Index.csv'")
else:
