...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GNS.ICTR.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Gross_savings.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Gross_savings.csv'")
else:
