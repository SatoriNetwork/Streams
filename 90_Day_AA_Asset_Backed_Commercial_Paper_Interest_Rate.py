...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=RIFSPPAAAD90NB&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('90_Day_AA_Asset_Backed_Commercial_Paper_Interest_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to '90_Day_AA_Asset_Backed_Commercial_Paper_Interest_Rate.csv'")
else:
