...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EG.FEC.RNEW.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Renewable_energy_consumption.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Renewable_energy_consumption.csv'")
else:
