...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.H2O.BASW.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('People_using_at_least_basic_drinking_water_services.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'People_using_at_least_basic_drinking_water_services.csv'")
else:
