...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=GASREGCOVW&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("US_Regular_All_Formulations_Gas_Price.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to US_Regular_All_Formulations_Gas_Price.csv")
else:
