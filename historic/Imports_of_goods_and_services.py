...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NE.IMP.GNFS.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Imports_of_goods_and_services.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Imports_of_goods_and_services.csv'")
else:
