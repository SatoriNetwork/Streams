...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.STA.OWAD.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Prevalence_of_overweight.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Prevalence_of_overweight.csv'")
else:
