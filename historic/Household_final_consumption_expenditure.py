...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NE.CON.PRVT.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Household_final_consumption_expenditure.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Household_final_consumption_expenditure.csv'")
else:
