...
url = "https://api.worldbank.org/v2/country/WLD/indicator/GB.XPD.RSDV.GD.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Research_and_development_expenditure.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Research_and_development_expenditure.csv'")
else:
