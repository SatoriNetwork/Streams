# Fed Swaps with Foreign Central Banks
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=SWPT&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Fed_Swaps_with_Foreign_Central_Banks.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Fed_Swaps_with_Foreign_Central_Banks.csv")
else:
