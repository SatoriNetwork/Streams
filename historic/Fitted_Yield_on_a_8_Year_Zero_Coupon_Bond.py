...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=THREEFY8&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Fitted_Yield_on_a_8_Year_Zero_Coupon_Bond.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Fitted_Yield_on_a_8_Year_Zero_Coupon_Bond.csv'")
else:
