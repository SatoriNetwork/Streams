...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=EFFR99&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Effective_Federal_Funds_Rate_99th_Percentile.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Effective_Federal_Funds_Rate_99th_Percentile.csv'")
else:
