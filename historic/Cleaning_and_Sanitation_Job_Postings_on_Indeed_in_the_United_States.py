...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=IHLIDXUSTPCLSA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Cleaning_and_Sanitation_Job_Postings_on_Indeed_in_the_United_States.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Cleaning_and_Sanitation_Job_Postings_on_Indeed_in_the_United_States.csv'")
else:
