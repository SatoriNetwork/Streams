...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GDP.PCAP.PP.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('GDP_per_capita.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'GDP_per_capita.csv'")
else:
