...
url = "https://api.worldbank.org/v2/country/WLD/indicator/AG.PRD.FOOD.XD?format=json"
...
if response.status_code == 200:
    ...
    with open('Food_production_index.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Food_production_index.csv'")
else:
