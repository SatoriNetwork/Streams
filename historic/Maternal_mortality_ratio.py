...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.STA.MMRT?format=json"
...
if response.status_code == 200:
    ...
    with open('Maternal_mortality_ratio.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Maternal_mortality_ratio.csv'")
else:
