...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=AMTMNO&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Value_of_Manufacturers_New_Orders_for_All_Manufacturing_Industries.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Value_of_Manufacturers_New_Orders_for_All_Manufacturing_Industries.csv'")
else:
