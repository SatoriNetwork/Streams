...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=PCESC96&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Real_Personal_Consumption_Expenditures.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Real_Personal_Consumption_Expenditures.csv'")
else:
