...
url = "https://api.worldbank.org/v2/country/WLD/indicator/TX.VAL.TECH.MF.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('High_technology_exports.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'High_technology_exports.csv'")
else:
