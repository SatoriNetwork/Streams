...
url = "https://api.worldbank.org/v2/country/WLD/indicator/IC.LGL.CRED.XQ?format=json"
...
if response.status_code == 200:
    ...
    with open('Strength_of_legal_rights_index.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Strength_of_legal_rights_index.csv'")
else:
