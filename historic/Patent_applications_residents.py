...
url = "https://api.worldbank.org/v2/country/WLD/indicator/IP.PAT.RESD?format=json"
...
if response.status_code == 200:
    ...
    with open('Patent_applications_residents.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Patent_applications_residents.csv'")
else:
