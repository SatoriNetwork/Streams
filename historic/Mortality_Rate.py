...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SP.DYN.IMRT.IN?format=json"
...
if response.status_code == 200:
    ...
    with open('Mortality_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Mortality_Rate.csv'")
else:
