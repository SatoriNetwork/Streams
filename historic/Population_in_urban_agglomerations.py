...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EN.URB.MCTY.TL.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Population_in_urban_agglomerations.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Population_in_urban_agglomerations.csv'")
else:
