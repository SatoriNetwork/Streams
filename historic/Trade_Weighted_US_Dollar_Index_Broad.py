...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=TWEXBMTH&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Trade_Weighted_US_Dollar_Index_Broad.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Trade_Weighted_US_Dollar_Index_Broad.csv'")
else:
