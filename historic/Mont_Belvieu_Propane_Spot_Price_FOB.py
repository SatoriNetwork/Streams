...
url = "https://api.eia.gov//v2//seriesid//PET.EER_EPLLPA_PF4_Y44MB_DPG.D?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('Mont_Belvieu_Propane_Spot_Price_FOB.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to Mont_Belvieu_Propane_Spot_Price_FOB.csv")
else:
