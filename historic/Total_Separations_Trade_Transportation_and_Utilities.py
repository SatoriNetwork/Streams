...
if response.status_code == 200:
    ...
    with open('Total_Separations_Trade_Transportation_and_Utilities.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Total_Separations_Trade_Transportation_and_Utilities.csv'")
else:
