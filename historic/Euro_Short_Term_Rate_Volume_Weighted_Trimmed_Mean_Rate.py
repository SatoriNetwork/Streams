...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=ECBESTRVOLWGTTRMDMNRT&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Euro_Short_Term_Rate_Volume_Weighted_Trimmed_Mean_Rate .csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Euro_Short_Term_Rate_Volume_Weighted_Trimmed_Mean_Rate.csv'")
else:
