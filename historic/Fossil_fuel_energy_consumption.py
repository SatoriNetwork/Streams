...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EG.USE.COMM.FO.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Fossil_fuel_energy_consumption.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Fossil_fuel_energy_consumption.csv'")
else:
