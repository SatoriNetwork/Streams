...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=WIUR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Wisconsin_Unemployment_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Wisconsin_Unemployment_Rate.csv'")
else:
