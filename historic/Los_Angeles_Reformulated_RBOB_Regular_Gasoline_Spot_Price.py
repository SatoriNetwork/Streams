...
url = "https://api.eia.gov//v2//seriesid//PET.EER_EPMRR_PF4_Y05LA_DPG.D?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('Los_Angeles_Reformulated_RBOB_Regular_Gasoline_Spot_Price.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to Los_Angeles_Reformulated_RBOB_Regular_Gasoline_Spot_Price.csv")
else:
