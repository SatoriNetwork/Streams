# U.S. Refinery and Blender Net Production of Finished Motor Gasoline
# Generate CSV
import requests
import json
...
url = "https://api.eia.gov//v2//seriesid//PET.MGFRPUS1.M?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('US_Refinery_and_Blender_Net_Production_of_Finished_Motor_Gasoline.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to US_Refinery_and_Blender_Net_Production_of_Finished_Motor_Gasoline.csv")
else:
...
url = "https://api.eia.gov//v2//seriesid//NG.MGFRPUS1.M?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
response = requests.get(url)
