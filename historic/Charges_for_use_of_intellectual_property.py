...
url = "https://api.worldbank.org/v2/country/WLD/indicator/BX.GSR.ROYL.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('Charges_for_use_of_intellectual_property.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Charges_for_use_of_intellectual_property.csv'")
else:
