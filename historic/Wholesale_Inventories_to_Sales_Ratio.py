...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=WHLSLRIRSA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Wholesale_Inventories_to_Sales_Ratio.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Wholesale_Inventories_to_Sales_Ratio.csv'")
else:
