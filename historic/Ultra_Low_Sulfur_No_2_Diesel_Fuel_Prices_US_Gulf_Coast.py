...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DDFUELUSGULF&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Ultra_Low_Sulfur_No_2_Diesel_Fuel_Prices_US_Gulf_Coast.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Ultra_Low_Sulfur_No_2_Diesel_Fuel_Prices_US_Gulf_Coast.csv'")
else:
