...
url = "https://data.nasdaq.com/api/v3/datatables/QDL/BCHAIN?code=TOTBC&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('Total_bitcoin_mined.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Total_bitcoin_mined.csv")
else:
