...
url = "https://api.worldbank.org/v2/country/WLD/indicator/AG.LND.CROP.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Permanent_cropland.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Permanent_cropland.csv'")
else:
