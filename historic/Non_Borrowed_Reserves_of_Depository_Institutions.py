...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=BOGNONBR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Non_Borrowed_Reserves_of_Depository_Institutions.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Non_Borrowed_Reserves_of_Depository_Institutions.csv")
else:
