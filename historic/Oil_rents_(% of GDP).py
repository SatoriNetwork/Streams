...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GDP.PETR.RT.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Oil_rents_(% of GDP).csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Oil_rents_(% of GDP).csv'")
else:
