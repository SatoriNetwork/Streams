...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EG.ELC.COAL.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Coal_electricity_output.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Coal_electricity_output.csv'")
else:
