...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GDP.NGAS.RT.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Natural_gas_rents.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Natural_gas_rents.csv'")
else:
