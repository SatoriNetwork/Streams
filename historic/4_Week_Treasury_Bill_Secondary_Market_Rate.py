...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DTB4WK&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('4_Week_Treasury_Bill_Secondary_Market_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to '4_Week_Treasury_Bill_Secondary_Market_Rate.csv'")
else:
