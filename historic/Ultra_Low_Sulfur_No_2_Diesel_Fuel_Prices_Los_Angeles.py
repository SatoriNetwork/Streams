...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DDFUELLA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Ultra_Low_Sulfur_No_2_Diesel_Fuel_Prices_Los_Angeles.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Ultra_Low_Sulfur_No_2_Diesel_Fuel_Prices_Los_Angeles.csv'")
else:
