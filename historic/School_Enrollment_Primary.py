...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SE.PRM.ENRR?format=json"
...
if response.status_code == 200:
    ...
    with open('School_Enrollment_Primary.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'School_Enrollment_Primary.csv'")
else:
