...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GDP.FRST.RT.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Forest_rents(% of GDP).csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Forest_rents(% of GDP).csv'")
else:
