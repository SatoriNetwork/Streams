# North Carolina House Price Index
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=NCSTHPI&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('North_Carolina_House_Price_Index.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'North_Carolina_House_Price_Index.csv'")
else:
