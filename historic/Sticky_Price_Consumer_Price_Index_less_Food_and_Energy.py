...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CORESTICKM159SFRBATL&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Sticky_Price_Consumer_Price_Index_less_Food_and_Energy.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Sticky_Price_Consumer_Price_Index_less_Food_and_Energy.csv'")
else:
