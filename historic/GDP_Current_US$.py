...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GDP.MKTP.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('GDP_Current_US$.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'GDP_Current_US$.csv'")
else:
