...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=RIMLPBAARNB&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Moodys_Yield_on_Seasoned_Corporate_Bonds_All_Industries_BAA.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Moodys_Yield_on_Seasoned_Corporate_Bonds_All_Industries_BAA.csv'")
else:
