...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SP.POP.DPND?format=json"
...
if response.status_code == 200:
    ...
    with open('Migration_Data.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Migration_Data.csv'")
else:
