...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=AWHAETP&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Average_Weekly_Hours_All_Employees.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Average_Weekly_Hours_All_Employees.csv'")
else:
