...
url = "https://data.nasdaq.com/api/v3/datatables/ZILLOW/DATA?indicator_id=ZSFH&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('ZHVI_Single_Family_Homes.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to ZHVI_Single_Family_Homes.csv")
else:
