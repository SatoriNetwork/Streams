...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GDP.COAL.RT.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Coal_rents.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Coal_rents.csv'")
else:
