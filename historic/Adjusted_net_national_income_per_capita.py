...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.ADJ.NNTY.PC.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('Adjusted_net_national_income_per_capita.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Adjusted_net_national_income_per_capita.csv'")
else:
