# Public sector management rating
import requests
import json
import datetime as dt
import csv

url = "https://api.worldbank.org/v2/country/WLD/indicator/IQ.CPA.PUBS.XQ?format=json"
...
if response.status_code == 200:
    ...
    with open('Public_sector_management_rating.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Public_sector_management_rating.csv'")
else:
