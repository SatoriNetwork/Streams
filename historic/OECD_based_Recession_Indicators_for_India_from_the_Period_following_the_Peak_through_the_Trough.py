...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=INDRECD&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('OECD_based_Recession_Indicators_for_India_from_the_Period_following_the_Peak_through_the_Trough.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'OECD_based_Recession_Indicators_for_India_from_the_Period_following_the_Peak_through_the_Trough.csv'")
else:
