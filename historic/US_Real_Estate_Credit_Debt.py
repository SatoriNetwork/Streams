# US Real Estate Credit Debt
import requests
import json
import datetime as dt
import csv

url = "https://api.stlouisfed.org/fred/series/observations?series_id=USRECD&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('US_Real_Estate_Credit_Debt.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'US_Real_Estate_Credit_Debt.csv'")
else:
