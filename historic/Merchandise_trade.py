...
url = "https://api.worldbank.org/v2/country/WLD/indicator/TG.VAL.TOTL.GD.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Merchandise_trade.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Merchandise_trade.csv'")
else:
