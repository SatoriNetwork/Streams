...
url = "https://api.worldbank.org/v2/country/WLD/indicator/IP.JRN.ARTC.SC?format=json"
...
if response.status_code == 200:
    ...
    with open('Scientific_journal_articles.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Scientific_journal_articles.csv'")
else:
