...
url = "https://api.worldbank.org/v2/country/WLD/indicator/BX.TRF.PWKR.CD.DT?format=json"
...
if response.status_code == 200:
    ...
    with open('Personal_remittances_received(current US$).csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Personal_remittances_received(current US$).csv'")
else:
