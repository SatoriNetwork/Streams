...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=JNJ&outputsize=full&apikey=YOUR_API_KEY"
...
if response.status_code == 200:
    ...
    with open('Johnson&Johnson.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Johnson&Johnson.csv")
else:
