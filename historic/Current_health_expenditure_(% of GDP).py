...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.XPD.CHEX.GD.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Current_health_expenditure_(% of GDP).csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Current_health_expenditure_(% of GDP).csv'")
else:
