...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=LAUTONSA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Light_Weight_Vehicle_Sales_Autos_and_Light_Trucks.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Light_Weight_Vehicle_Sales_Autos_and_Light_Trucks.csv'")
else:
