...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=TLBACBM027SBOG&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Asset_Backed_Securities_Outstanding.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Asset_Backed_Securities_Outstanding.csv'")
else:
