...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.DYN.AIDS.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Prevalence_of_HIV_total.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Prevalence_of_HIV_total.csv'")
else:
