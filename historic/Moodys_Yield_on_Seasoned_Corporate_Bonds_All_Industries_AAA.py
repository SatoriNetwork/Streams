...
if response.status_code == 200:
    ...
    with open('Moodys_Yield_on_Seasoned_Corporate_Bonds_All_Industries_AAA.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Moodys_Yield_on_Seasoned_Corporate_Bonds_All_Industries_AAA.csv'")
else:
