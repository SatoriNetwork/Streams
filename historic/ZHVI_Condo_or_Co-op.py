...
url = "https://data.nasdaq.com/api/v3/datatables/ZILLOW/DATA?indicator_id=ZCON&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('ZHVI_Condo_or_Co-op.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to ZHVI_Condo_or_Co-op.csv")
else:
