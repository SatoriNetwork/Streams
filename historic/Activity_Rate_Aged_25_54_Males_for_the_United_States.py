...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=LRAC25MAUSM156S&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Activity_Rate_Aged_25_54_Males_for_the_United_States.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Activity_Rate_Aged_25_54_Males_for_the_United_States.csv'")
else:
