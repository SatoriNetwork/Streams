...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=TLAACBM027SBOG&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Total_Loans_and_Leases_of_Commercial_Banks.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Total_Loans_and_Leases_of_Commercial_Banks.csv'")
else:
