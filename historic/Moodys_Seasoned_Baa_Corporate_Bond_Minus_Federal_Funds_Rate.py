...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=BAAFF&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Moodys_Seasoned_Baa_Corporate_Bond_Minus_Federal_Funds_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Moodys_Seasoned_Baa_Corporate_Bond_Minus_Federal_Funds_Rate.csv'")
else:
