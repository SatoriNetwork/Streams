...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=GFDEGDQ188S&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Total_Public_Debt_as_Percent_of_Gross_Domestic_Product.csv', 'w', newline='') as csvfile:
        ...
        for obs in observations:
            ...
            try:
                ...
                continue
    print("Data has been saved to 'Total_Public_Debt_as_Percent_of_Gross_Domestic_Product.csv'")
else:
