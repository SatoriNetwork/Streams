...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=FFWSJHIGH&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('High_Value_of_the_Federal_Funds_Rate_for_the_Indicated_Date_Published_in_The_Wall_Street_Journal.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'High_Value_of_the_Federal_Funds_Rate_for_the_Indicated_Date_Published_in_The_Wall_Street_Journal.csv'")
else:
