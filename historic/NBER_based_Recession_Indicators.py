...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=USREC&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("NBER_based_Recession_Indicators.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to NBER_based_Recession_Indicators.csv")
else:
