...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=W006RC1Q027SBEA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open(' Federal_government_current_tax_receipts.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Federal_government_current_tax_receipts.csv'")
else:
