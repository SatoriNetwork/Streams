...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=JPM&outputsize=full&apikey=YOUR_API_KEY"
...
if response.status_code == 200:
    ...
    with open('JPMorgan_Chase.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to JPMorgan_Chase.csv")
else:
