...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NE.GDI.FTOT.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Gross_capital_formation(% of GDP).csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Gross_capital_formation(% of GDP).csv'")
else:
