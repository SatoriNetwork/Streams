# Median Sales Price Houses Sold
import requests
import json
import datetime as dt
import csv

url = "https://api.stlouisfed.org/fred/series/observations?series_id=HOSMEDUSM052N&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Median_Sales_Price_Houses_Sold.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Median_Sales_Price_Houses_Sold.csv'")
else:
