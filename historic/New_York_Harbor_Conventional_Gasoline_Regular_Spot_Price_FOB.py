...
url = "https://api.eia.gov//v2//seriesid//PET.EER_EPMRU_PF4_Y35NY_DPG.D?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('New_York_Harbor_Conventional_Gasoline_Regular_Spot_Price_FOB.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to New_York_Harbor_Conventional_Gasoline_Regular_Spot_Price_FOB.csv")
else:
