# Building Permits Not Seasonally Adjusted
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=PERMITNSA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Building_Permits_Not_Seasonally_Adjusted.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Building_Permits_Not_Seasonally_Adjusted.csv'")
else:
