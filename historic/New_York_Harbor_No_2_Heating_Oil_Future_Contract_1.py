# New York Harbor No. 2 Heating Oil Future Contract 1 
# Generate CSV
import requests
import json
...
url = "https://api.eia.gov//v2//seriesid//PET.EER_EPD2F_PE1_Y35NY_DPG.D?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('New_York_Harbor_No_2_Heating_Oil_Future_Contract_1.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to New_York_Harbor_No_2_Heating_Oil_Future_Contract_1.csv")
else:
