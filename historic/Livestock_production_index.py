...
url = "https://api.worldbank.org/v2/country/WLD/indicator/AG.PRD.LVSK.XD?format=json"
...
if response.status_code == 200:
    ...
    with open('Livestock_production_index.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Livestock_production_index.csv'")
else:
