...
url = "https://api.eia.gov//v2//seriesid//PET.EER_EPD2DXL0_PF4_RGC_DPG.D?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('Los_Angeles_Ultra_Low_Sulfur_CARB_Diesel_Spot_Price.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to Los_Angeles_Ultra_Low_Sulfur_CARB_Diesel_Spot_Price.csv")
else:
