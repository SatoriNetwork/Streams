# Personal remittances, paid (% of GDP)
# Generate CSV
import requests
import json
...
url = "https://api.worldbank.org/v2/country/WLD/indicator/BM.TRF.PWKR.CD.DT?format=json"
...
if response.status_code == 200:
    ...
    with open('Personal_remittances_paid.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Personal_remittances_paid.csv'")
else:
