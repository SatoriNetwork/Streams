...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SP.URB.TOTL.IN.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Urban_population.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Urban_population.csv'")
else:
