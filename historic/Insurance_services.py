...
url = "https://api.worldbank.org/v2/country/WLD/indicator/BX.GSR.INSF.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Insurance_services.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Insurance_services.csv'")
else:
