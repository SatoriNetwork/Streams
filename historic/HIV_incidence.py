...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.HIV.INCD.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('HIV_incidence.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'HIV_incidence.csv'")
else:
