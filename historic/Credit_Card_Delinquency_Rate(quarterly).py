...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=TERMCBCCALLNS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Credit_Card_Delinquency_Rate(quarterly).csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Credit_Card_Delinquency_Rate(quarterly).csv'")
else:
