...
if response.status_code == 200:
    ...
    with open('Government_expenditure_on_education_total.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Government_expenditure_on_education_total.csv'")
else:
