...
url = "https://api.worldbank.org/v2/country/WLD/indicator/TX.VAL.MRCH.CD.WT?format=json"
...
if response.status_code == 200:
    ...
    with open('Merchandise_exports.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Merchandise_exports.csv'")
else:
