...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=THREEFFTP5&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Instantaneous_Forward_Term_Premium_5_Years_Hence.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Instantaneous_Forward_Term_Premium_5_Years_Hence.csv'")
else:
