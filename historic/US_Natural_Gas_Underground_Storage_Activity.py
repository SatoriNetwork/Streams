# U.S. Natural Gas Underground Storage Activity
# Generate CSV
import requests
import json
...
url = "https://api.eia.gov//v2//seriesid//NG.N9100US2.M?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('US_Natural_Gas_Underground_Storage_Activity.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to US_Natural_Gas_Underground_Storage_Activity.csv")
else:
