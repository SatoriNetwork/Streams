...
url = "https://api.worldbank.org/v2/country/WLD/indicator/VC.IHR.PSRC.P5?format=json"
...
if response.status_code == 200:
    ...
    with open('Intentional_homicides.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Intentional_homicides.csv'")
else:
