# West Coast All Grades Conventional Retail Gasoline Prices
# Generate CSV
import requests
import json
...
url = "https://api.eia.gov//v2//seriesid//PET.EMM_EPM0_PTE_SWA_DPG.M?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('West_Coast_All_Grades_Conventional_Retail_Gasoline_Prices.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to West_Coast_All_Grades_Conventional_Retail_Gasoline_Prices.csv")
else:
