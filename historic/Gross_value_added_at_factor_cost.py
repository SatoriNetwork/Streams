...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GDP.FCST.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('Gross_value_added_at_factor_cost.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Gross_value_added_at_factor_cost.csv'")
else:
