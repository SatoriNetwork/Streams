# All Federal Reserve Banks: Capital
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=WACBS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('All_Federal_Reserve_Banks_Capital.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'All_Federal_Reserve_Banks_Capital.csv'")
else:
