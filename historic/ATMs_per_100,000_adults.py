...
url = "https://api.worldbank.org/v2/country/WLD/indicator/FB.ATM.TOTL.P5?format=json"
...
if response.status_code == 200:
    ...
    with open('ATMs_per_100,000_adults.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'ATMs_per_100,000_adults.csv'")
else:
