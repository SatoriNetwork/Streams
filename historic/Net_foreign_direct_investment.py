...
url = "https://api.worldbank.org/v2/country/WLD/indicator/BX.KLT.DINV.CD.WD?format=json"
...
if response.status_code == 200:
    ...
    with open('Net_foreign_direct_investment.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Net_foreign_direct_investment.csv'")
else:
