...
if response.status_code == 200:
    ...
    with open('Real_Median_Household_Income_in_the_United_States.csv', 'w', newline='') as csvfile:
        ...
        for obs in observations:
            ...
            try:
                ...
                continue
    print("Data has been saved to 'Real_Median_Household_Income_in_the_United_States.csv'")
else:
