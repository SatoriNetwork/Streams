...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=XLE&outputsize=full&apikey=YOUR_API_KEY"
...
if response.status_code == 200:
    ...
    with open('Energy_Select_Sector_SPDR.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Energy_Select_Sector_SPDR.csv")
else:
