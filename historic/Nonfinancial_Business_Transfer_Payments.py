# Nonfinancial Business Transfer Payments
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=NNBTILQ027S&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Nonfinancial_Business_Transfer_Payments.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Nonfinancial_Business_Transfer_Payments.csv'")
else:
