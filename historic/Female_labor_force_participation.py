...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SL.TLF.CACT.FE.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Female_labor_force_participation.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Female_labor_force_participation.csv'")
else:
