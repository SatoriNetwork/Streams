...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.XPD.CHEX.PC.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('health_expenditure_per_capita_(current_US$).csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'health_expenditure_per_capita_(current_US$).csv'")
else:
