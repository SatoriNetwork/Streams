...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.MED.BEDS.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Hospital_beds.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Hospital_beds.csv'")
else:
