...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=T5YIFR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('5_Year_Forward_Inflation_Expectation_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to '5_Year_Forward_Inflation_Expectation_Rate.csv'")
else:
