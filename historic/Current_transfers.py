...
url = "https://api.worldbank.org/v2/country/WLD/indicator/BX.TRF.CURR.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('Current_transfers.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Current_transfers.csv'")
else:
