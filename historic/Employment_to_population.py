...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SL.EMP.TOTL.SP.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Employment_to_population.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Employment_to_population.csv'")
else:
