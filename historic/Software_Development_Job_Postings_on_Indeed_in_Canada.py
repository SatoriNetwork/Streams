...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=IHLIDXCATPSOFTDEVE&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Software_Development_Job_Postings_on_Indeed_in_Canada.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Software_Development_Job_Postings_on_Indeed_in_Canada.csv'")
else:
