...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DED3&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('US_Short_Term_Interest_Rates_Daily_3_Month_Eurodollar_Deposit_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'US_Short_Term_Interest_Rates_Daily_3_Month_Eurodollar_Deposit_Rate.csv'")
else:
