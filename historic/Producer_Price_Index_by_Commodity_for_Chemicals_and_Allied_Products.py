...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=WPU06&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Producer_Price_Index_by_Commodity_for_Chemicals_and_Allied_Products.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Producer_Price_Index_by_Commodity_for_Chemicals_and_Allied_Products.csv'")
else:
