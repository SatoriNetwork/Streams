...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.ADJ.DCO2.GN.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Carbon_dioxide_damage.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Carbon_dioxide_damage.csv'")
else:
