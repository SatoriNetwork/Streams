...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=ECBDFR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open(' European_Central_Bank_Deposit_Facility_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'European_Central_Bank_Deposit_Facility_Rate.csv'")
else:
