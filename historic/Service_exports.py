...
url = "https://api.worldbank.org/v2/country/WLD/indicator/BX.GSR.NFSV.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('Service_exports.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Service_exports.csv'")
else:
