...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.ADJ.DRES.GN.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Natural_resource_depletion.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Natural_resource_depletion.csv'")
else:
