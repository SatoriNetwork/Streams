...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SP.POP.GROW?format=json"
...
if response.status_code == 200:
    ...
    with open('Population_growth.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Population_growth.csv'")
else:
