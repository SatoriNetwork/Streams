...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=BAMLC0A1CAAAEY&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('AAA_Corporate_Bond_Yield.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'AAA_Corporate_Bond_Yield.csv'")
else:
