# All Employees: Educational Services
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CES6562000001&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('All_Employees_Educational_Services.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'All_Employees_Educational_Services.csv'")
else:
