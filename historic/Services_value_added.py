...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NV.SRV.TOTL.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Services_value_added.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Services_value_added.csv'")
else:
