# US_Gulf_Coast_Spot_Gasoline_Price
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DGASUSGULF&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('US_Gulf_Coast_Spot_Gasoline_Price.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'US_Gulf_Coast_Spot_Gasoline_Price.csv'")
else:
