...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.GDS.TOTL.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Gross_domestic_savings.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Gross_domestic_savings.csv'")
else:
