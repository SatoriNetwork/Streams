...
url = "https://api.eia.gov//v2//seriesid//PET.RCLC4.D?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('Cushing_Crude_Oil_Future_Contract_4.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to Cushing_Crude_Oil_Future_Contract_4.csv")
else:
