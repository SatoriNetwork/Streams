...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=TOTBUSSMSA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Total_Business_Sales.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Total_Business_Sales.csv'")
else:
