# Bitcoin Number of Tx per Block			
# Generate CSV
import requests
import json
...
url = "https://data.nasdaq.com/api/v3/datatables/QDL/BCHAIN?code=NTRBL&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('Bitcoin_Number_of_Tx_per_Block.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Bitcoin_Number_of_Tx_per_Block.csv")
else:
