# Wealth of Nonfinancial Corporate Business
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=WLFN&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Wealth_of_Nonfinancial_Corporate_Business.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Wealth_of_Nonfinancial_Corporate_Business.csv'")
else:
