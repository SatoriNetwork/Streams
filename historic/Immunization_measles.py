...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.IMM.MEAS?format=json"
...
if response.status_code == 200:
    ...
    with open('Immunization_measles.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Immunization_measles.csv'")
else:
