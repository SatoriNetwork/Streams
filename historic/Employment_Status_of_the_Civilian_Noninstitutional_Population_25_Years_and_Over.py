...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=LES1252881900Q&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open(' Employment_Status_of_the_Civilian_Noninstitutional_Population_25_Years_and_Over.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Employment_Status_of_the_Civilian_Noninstitutional_Population_25_Years_and_Over.csv'")
else:
