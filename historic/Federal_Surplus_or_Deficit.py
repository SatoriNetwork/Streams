...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=FYFSD&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Federal_Surplus_or_Deficit.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Federal_Surplus_or_Deficit.csv")
else:
