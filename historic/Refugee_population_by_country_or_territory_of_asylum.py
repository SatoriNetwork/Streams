...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SM.POP.REFG?format=json"
...
if response.status_code == 200:
    ...
    with open('Refugee_population_by_country_or_territory_of_asylum.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Refugee_population_by_country_or_territory_of_asylum.csv'")
else:
