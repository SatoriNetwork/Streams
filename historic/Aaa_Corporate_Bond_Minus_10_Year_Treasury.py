...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=AAA10Y&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Aaa_Corporate_Bond_Minus_10_Year_Treasury.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Aaa_Corporate_Bond_Minus_10_Year_Treasury.csv")
else:
