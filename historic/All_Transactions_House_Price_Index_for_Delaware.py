...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DESTHPI&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('All_Transactions_House_Price_Index_for_Delaware.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'All_Transactions_House_Price_Index_for_Delaware.csv'")
else:
