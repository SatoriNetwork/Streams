...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=W875RX1&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Corporate_Profits_After_Tax_without_IVA_and_CCAdj.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Personal_ICorporate_Profits_After_Tax_without_IVA_and_CCAdjncome.csv'")
else:
