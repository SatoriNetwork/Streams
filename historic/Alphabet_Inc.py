...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=GOOGL&outputsize=full&apikey=YOUR_API_KEY"
...
if response.status_code == 200:
    ...
    with open('Alphabet_Inc.csv', 'w', newline='') as csvfile:
        ...
        for date, values in reversed(sorted_data):
            ...
            try:
                ...
                continue
    # print(result)
    print("Data has been saved to Alphabet_Inc.csv")
else:
