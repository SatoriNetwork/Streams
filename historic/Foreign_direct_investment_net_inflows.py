...
url = "https://api.worldbank.org/v2/country/WLD/indicator/BX.KLT.DINV.WD.GD.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Foreign_direct_investment_net_inflows.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Foreign_direct_investment_net_inflows.csv'")
else:
