# Consumer Price Index: Energy in U.S. City Average
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CPIENGSL&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open("Consumer_Price_Index_Energy_in_US_City_Average.csv", 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Consumer_Price_Index_Energy_in_US_City_Average.csv")
else:
