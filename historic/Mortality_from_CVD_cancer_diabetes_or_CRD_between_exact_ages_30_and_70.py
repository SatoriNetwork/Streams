...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.DYN.NCOM.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Mortality_from_CVD_cancer_diabetes_or_CRD_between_exact_ages_30_and_70.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Mortality_from_CVD_cancer_diabetes_or_CRD_between_exact_ages_30_and_70.csv'")
else:
