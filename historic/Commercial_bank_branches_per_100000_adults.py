...
url = "https://api.worldbank.org/v2/country/WLD/indicator/FB.CBK.BRCH.P5?format=json"
...
if response.status_code == 200:
    ...
    with open('Commercial_bank_branches_per_100000_adults.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Commercial_bank_branches_per_100000_adults.csv'")
else:
