...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=NONREVSL&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Nonrevolving_Consumer_Credit_Owned_and_Securitized.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Nonrevolving_Consumer_Credit_Owned_and_Securitized.csv'")
else:
