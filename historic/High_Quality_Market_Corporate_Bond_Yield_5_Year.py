#  High Quality Market Corporate Bond Yield: 5-Year
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=HQMCB5YR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open(' High_Quality_Market_Corporate_Bond_Yield_5_Year.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'High_Quality_Market_Corporate_Bond_Yield_5_Year.csv'")
else:
