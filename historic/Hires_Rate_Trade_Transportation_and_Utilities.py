# Hires Rate: Trade, Transportation, and Utilities
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=JTS4000HIR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Hires_Rate_Trade_Transportation_and_Utilities.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Hires_Rate_Trade_Transportation_and_Utilities.csv'")
else:
