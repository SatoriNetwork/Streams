...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=MSACSR&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Supply_of_New_Houses.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Supply_of_New_Houses.csv'")
else:
