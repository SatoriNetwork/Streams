...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EG.ELC.PETR.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Oil_electricity_output.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Oil_electricity_output.csv'")
else:
