...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=ECOMSA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('E_Commerce_Retail_Sales_as_a_Percent_of_Total_Sales.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'E_Commerce_Retail_Sales_as_a_Percent_of_Total_Sales.csv'")
else:
