...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=SMCD678FRBCLE&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Contributions_to_the_Cleveland_Financial_Stress_Index_Stock_Market_Crashes.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Contributions_to_the_Cleveland_Financial_Stress_Index_Stock_Market_Crashes.csv'")
else:
