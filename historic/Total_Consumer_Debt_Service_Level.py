# Total Consumer Debt Service Level
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=TCDSL&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Total_Consumer_Debt_Service_Level.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Total_Consumer_Debt_Service_Level.csv'")
else:
