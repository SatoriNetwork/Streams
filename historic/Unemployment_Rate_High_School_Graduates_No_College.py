...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=LNU04027689&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Unemployment_Rate_High_School_Graduates_No_College.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Unemployment_Rate_High_School_Graduates_No_College.csv'")
else:
