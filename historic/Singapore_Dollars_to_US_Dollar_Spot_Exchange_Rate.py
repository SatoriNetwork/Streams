...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=DEXSIUS&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Singapore_Dollars_to_US_Dollar_Spot_Exchange_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Singapore_Dollars_to_US_Dollar_Spot_Exchange_Rate.csv'")
else:
