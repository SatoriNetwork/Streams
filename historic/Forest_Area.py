...
url = "https://api.worldbank.org/v2/country/WLD/indicator/AG.LND.FRST.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Forest_Area.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Forest_Area.csv'")
else:
