# Bitcoin My Wallet Number of Tx Per Day
# Generate CSV
import requests
import json
...
url = "https://data.nasdaq.com/api/v3/datatables/QDL/BCHAIN?code=MWNTD&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('Bitcoin_My_Wallet_Number_of_Tx_Per_Day.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Bitcoin_My_Wallet_Number_of_Tx_Per_Day.csv")
else:
