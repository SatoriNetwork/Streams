...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EN.ATM.GHGT.KT.CE?format=json"
...
if response.status_code == 200:
    ...
    with open('Greenhouse_gas_emissions.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Greenhouse_gas_emissions.csv'")
else:
