...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=RRPTTLD&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Reverse_Repurchase_Agreements_Total_Securities_Sold_by_the_Federal_Reserve_in_the_Temporary_Open_Market_Operations.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Reverse_Repurchase_Agreements_Total_Securities_Sold_by_the_Federal_Reserve_in_the_Temporary_Open_Market_Operations.csv'")
else:
