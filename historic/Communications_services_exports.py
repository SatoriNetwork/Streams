...
url = "https://api.worldbank.org/v2/country/WLD/indicator/BX.GSR.CMCP.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Communications_services_exports.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Communications_services_exports.csv'")
else:
