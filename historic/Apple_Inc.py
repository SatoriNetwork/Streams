...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=AAPL&outputsize=full&apikey=YOUR_API_KEY"
...
if response.status_code == 200:
    ...
    with open('Apple_Inc.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to Apple_Inc.csv")
else:
