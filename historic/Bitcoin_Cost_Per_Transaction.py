...
url = "https://data.nasdaq.com/api/v3/datatables/QDL/BCHAIN?code=CPTRA&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('Bitcoin_Cost_Per_Transaction.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Bitcoin_Cost_Per_Transaction.csv")
else:
