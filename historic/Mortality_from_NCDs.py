...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SH.DTH.NCOM.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Mortality_from_NCDs.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Mortality_from_NCDs.csv'")
else:
