...
url = "https://api.worldbank.org/v2/country/WLD/indicator/BX.GSR.CCIS.CD?format=json"
...
if response.status_code == 200:
    ...
    with open('ICT_service_exports.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'ICT_service_exports.csv'")
else:
