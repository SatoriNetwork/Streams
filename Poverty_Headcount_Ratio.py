...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SI.POV.DDAY?format=json"
...
if response.status_code == 200:
    ...
    with open('Poverty_Headcount_Ratio.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Poverty_Headcount_Ratio.csv'")
else:
