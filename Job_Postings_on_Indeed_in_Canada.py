# Job Postings on Indeed in Canada
import requests
import json
import datetime as dt
import csv

url = "https://api.stlouisfed.org/fred/series/observations?series_id=IHLIDXCA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Job_Postings_on_Indeed_in_Canada.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Job_Postings_on_Indeed_in_Canada.csv'")
else:
