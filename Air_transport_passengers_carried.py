...
url = "https://api.worldbank.org/v2/country/WLD/indicator/IS.AIR.PSGR?format=json"
...
if response.status_code == 200:
    ...
    with open('Air_transport_passengers_carried.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Air_transport_passengers_carried.csv'")
else:
