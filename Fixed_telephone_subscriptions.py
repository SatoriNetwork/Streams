...
url = "https://api.worldbank.org/v2/country/WLD/indicator/IT.MLT.MAIN.P2?format=json"
...
if response.status_code == 200:
    ...
    with open('Fixed_telephone_subscriptions.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Fixed_telephone_subscriptions.csv'")
else:
