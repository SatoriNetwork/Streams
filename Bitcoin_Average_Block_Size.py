...
url = "https://data.nasdaq.com/api/v3/datatables/QDL/BCHAIN?code=AVBLS&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('Bitcoin_Average_Block_Size.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Bitcoin_Average_Block_Size.csv")
else:
