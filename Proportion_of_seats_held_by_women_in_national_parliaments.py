...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SG.GEN.PARL.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Proportion_of_seats_held_by_women_in_national_parliaments.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Proportion_of_seats_held_by_women_in_national_parliaments.csv'")
else:
