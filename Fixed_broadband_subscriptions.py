...
url = "https://api.worldbank.org/v2/country/WLD/indicator/IT.NET.BBND.P2?format=json"
...
if response.status_code == 200:
    ...
    with open('Fertility_rate_total_women.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Fertility_rate_total_women.csv'")
else:
