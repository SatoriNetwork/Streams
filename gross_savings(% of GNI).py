...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NY.ADJ.ICTR.GN.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('gross_savings(% of GNI).csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'gross_savings(% of GNI).csv'")
else:
