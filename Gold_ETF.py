...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=GLD&outputsize=full&apikey=YOUR_API_KEY"
...
if response.status_code == 200:
    ...
    with open('Gold_ETF.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to Gold_ETF.csv")
else:
