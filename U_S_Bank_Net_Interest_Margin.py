...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=USNIM&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('U_S_Bank_Net_Interest_Margin.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'U_S_Bank_Net_Interest_Margin.csv'")
else:
