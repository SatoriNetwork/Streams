...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NE.TRD.GNFS.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Trade(% of GDP).csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Trade(% of GDP).csv'")
else:
