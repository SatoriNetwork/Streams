# Real Gross Domestic Product for Spain
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CLVMEURSCAB1GQES&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open(' Real_Gross_Domestic_Product_for_Spain.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Real_Gross_Domestic_Product_for_Spain.csv'")
else:
