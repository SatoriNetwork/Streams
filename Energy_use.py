...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EG.USE.PCAP.KG.OE?format=json"
...
if response.status_code == 200:
    ...
    with open('Energy_use.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Energy_use.csv'")
else:
