...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SE.SEC.ENRR?format=json"
...
if response.status_code == 200:
    ...
    with open('School_enrollment_secondary.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'School_enrollment_secondary.csv'")
else:
