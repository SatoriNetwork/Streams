# Bitcoin Median Transaction Conf. Time
# Generate CSV
import requests
import json
...
url = "https://data.nasdaq.com/api/v3/datatables/QDL/BCHAIN?code=ATRCT&api_key=zjsgHD-jbXKBVezYzyqT"
...
if response.status_code == 200:
    ...
    with open('Bitcoin_Median_Transaction_Conf.Time.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Bitcoin_Median_Transaction_Conf.Time.csv")
else:
