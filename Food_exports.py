...
url = "https://api.worldbank.org/v2/country/WLD/indicator/TX.VAL.FOOD.ZS.UN?format=json"
...
if response.status_code == 200:
    ...
    with open('Food_exports.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Food_exports.csv'")
else:
