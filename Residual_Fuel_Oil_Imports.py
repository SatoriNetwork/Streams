...
url = "https://api.eia.gov//v2//seriesid//PET.MREIMUS1.M?api_key=wxFRLAoaTMQ9Ra7NvakhNKSxxstutZsG28nuerWR"
...
if response.status_code == 200:
    ...
    with open('Residual_Fuel_Oil_Imports.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(['index', 'value'])  # Write the header
        csvwriter.writerows(result)

    print("Data has been saved to Residual_Fuel_Oil_Imports.csv")
else:
