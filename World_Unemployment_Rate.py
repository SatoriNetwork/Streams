...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SL.UEM.TOTL.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('World_Unemployment_Rate.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'World_Unemployment_Rate.csv'")
else:
