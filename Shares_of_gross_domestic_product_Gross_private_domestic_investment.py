...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=A229RX0&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Shares_of_gross_domestic_product_Gross_private_domestic_investment.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Shares_of_gross_domestic_product_Gross_private_domestic_investment.csv'")
else:
