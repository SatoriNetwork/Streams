# Producer Price Index for Textile Mills
# Generate CSV
import requests
import json
...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=PCU313313&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Producer_Price_Index_for_Textile_Mills.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to 'Producer_Price_Index_for_Textile_Mills.csv'")
else:
