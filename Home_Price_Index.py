...
url = "https://api.stlouisfed.org/fred/series/observations?series_id=CSUSHPINSA&api_key=7ef44306675240d156b2b8786339b867&file_type=json"
...
if response.status_code == 200:
    ...
    with open('Home_Price_Index.csv', 'w', newline='') as csvfile:
        ...
        for obs in observations:
            ...
            try:
                ...
                continue
    # print(result)
    print("Data has been saved to 'Home_Price_Index.csv'")
else:
