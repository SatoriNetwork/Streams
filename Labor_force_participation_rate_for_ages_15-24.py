...
url = "https://api.worldbank.org/v2/country/WLD/indicator/SL.TLF.ACTI.1524.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Labor_force_participation_rate_for_ages_15-24.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Labor_force_participation_rate_for_ages_15-24.csv'")
else:
