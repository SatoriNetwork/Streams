...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=META&outputsize=full&apikey=YOUR_API_KEY"
...
if response.status_code == 200:
    ...
    with open('Meta_Platforms_Inc.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Meta_Platforms_Inc.csv")
else:
