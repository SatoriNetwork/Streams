...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=WMT&outputsize=full&apikey=YOUR_API_KEY"
...
if response.status_code == 200:
    ...
    with open('Walmart_Inc.csv', 'w', newline='') as csvfile:
    ...
    print("Data has been saved to Walmart_Inc.csv")
else:
