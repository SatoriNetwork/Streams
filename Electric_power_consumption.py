...
url = "https://api.worldbank.org/v2/country/WLD/indicator/EG.USE.ELEC.KH.PC?format=json"
...
if response.status_code == 200:
    ...
    with open('Electric_power_consumption.csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Electric_power_consumption.csv'")
else:
