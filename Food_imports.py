...
url = "https://api.worldbank.org/v2/country/WLD/indicator/TM.VAL.FOOD.ZS.UN?format=json"
...
if response.status_code == 200:
    ...
    with open('Food_imports.csv', 'w', newline='') as csvfile:
        ...
        for item in sorted_data:
            ...
            if value is not None:
                try:
                    ...
                    continue
    print("Data has been saved to 'Food_imports.csv'")
else:
