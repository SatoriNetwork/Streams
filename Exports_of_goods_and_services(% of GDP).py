...
url = "https://api.worldbank.org/v2/country/WLD/indicator/NE.EXP.GNFS.ZS?format=json"
...
if response.status_code == 200:
    ...
    with open('Exports_of_goods_and_services(% of GDP).csv', 'w', newline='') as csvfile:
    ...
    # print(result)
    print("Data has been saved to 'Exports_of_goods_and_services(% of GDP).csv'")
else:
